...
QMAKE    = /usr/bin/qmake
eDTGui.xcodeproj/project.pbxproj: eDTGui.pro  /usr/local/Qt4.5/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.5/mkspecs/macx-xcode -macx -o eDTGui.xcodeproj/project.pbxproj eDTGui.pro
