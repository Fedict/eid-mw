...
static int finalize_called = 0; /* Belpic */
...
CK_RV C_GetInfo(CK_INFO_PTR pInfo)
{
	...
	strcpy_bp(pInfo->libraryDescription,
          "Belgium eID PKCS#11 interface",
		  sizeof(pInfo->libraryDescription));
	pInfo->libraryVersion.major = 1; /* Belpic version */
	pInfo->libraryVersion.minor = 9; /* Belpic version */
