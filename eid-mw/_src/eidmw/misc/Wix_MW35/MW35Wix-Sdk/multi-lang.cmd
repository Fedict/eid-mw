...
set MSI_FILE_IN=BeidMW35-Sdk
set MSI_FILE_OUT=BeidMW35-Sdk
...
"%BEID_DIR_PLATFORMSDK_2008%\msidb.exe" -d "%OUT_PATH%\%MSI_FILE_OUT%.msi" -r "%MST_DIR%\fr.mst"
"%BEID_DIR_PLATFORMSDK_2008%\msidb.exe" -d "%OUT_PATH%\%MSI_FILE_OUT%.msi" -r "%MST_DIR%\de.mst"
