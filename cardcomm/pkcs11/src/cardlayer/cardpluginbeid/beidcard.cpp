...
 CByteArray CBeidCard::Ctrl(long ctrl, const CByteArray & oCmdData) 
{
		...
		
	{
				...
				
			{
					...
					SendAPDU(0xEA, 0x02, ucPinRef, 0x81);
				...
				
			{
					...
					SendAPDU(0x88, 0x02, ucKeyRef, oData);
					...
					
				{
			       ...
			       L"Ctrl(): Unknown CRTL code %d (0x%0x) specified",
			       ctrl, ctrl);
