...
DLGS_EXPORT DlgRet eIDMW::DlgAskPin(DlgPinOperation operation, DlgPinUsage usage,
                                    const wchar_t * wsPinName, DlgPinInfo pinInfo, wchar_t * wsPin,
...
DLGS_EXPORT DlgRet eIDMW::DlgAskPins(DlgPinOperation operation,
                                     ...
                                     unsigned long ulPin1BufferLen, DlgPinInfo pin2Info,
                                     wchar_t * wsPin2, unsigned long ulPin2BufferLen) {
...
DLGS_EXPORT DlgRet eIDMW::DlgBadPin(DlgPinUsage usage, const wchar_t * wsPinName,
...
DLGS_EXPORT DlgRet eIDMW::DlgDisplayPinpadInfo(DlgPinOperation operation, const wchar_t * wsReader,
...
DLGS_EXPORT DlgRet eIDMW::DlgAskAccess(const wchar_t * wsAppPath, const wchar_t * wsReaderName,
