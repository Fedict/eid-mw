...
//GENERAL
	...
	const struct CConfig::Param_Str CConfig::
		...
		{ EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_INSTALL_PRO_DIR, L"$home" };
	const struct CConfig::Param_Str CConfig::
		EIDMW_CONFIG_PARAM_GENERAL_INSTALL_SDK_DIR =
		{ EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_INSTALL_SDK_DIR, L"$home" };
	const struct CConfig::Param_Str CConfig::
...
//CRL
	...
	const struct CConfig::Param_Str CConfig::
		...
		{ EIDMW_CNF_SECTION_CRL, EIDMW_CNF_CRL_CACHEFILE, L".cache.cdc" };
	const struct CConfig::Param_Str CConfig::
		EIDMW_CONFIG_PARAM_CRL_LOCKFILE =
		{ EIDMW_CNF_SECTION_CRL, EIDMW_CNF_CRL_LOCKFILE, L".crllock.flg" };

//CERTIFICATE VALIDATION
	const struct CConfig::Param_Num CConfig::
		EIDMW_CONFIG_PARAM_CERTVALID_ALLOWTESTC =
		{ EIDMW_CNF_SECTION_CERTVALID, EIDMW_CNF_CERTVALID_ALLOWTESTC, 0 };
	const struct CConfig::Param_Num CConfig::
...
//CERTIFICATE CACHE
	const struct CConfig::Param_Str CConfig::
		...
		{ EIDMW_CNF_SECTION_CERTCACHE, EIDMW_CNF_CERTCACHE_CACHEFILE, L"$common" WDIRSEP L".cache.csc" };
	const struct CConfig::Param_Num CConfig::
		EIDMW_CONFIG_PARAM_CERTCACHE_LINENUMB =
		{ EIDMW_CNF_SECTION_CERTCACHE, EIDMW_CNF_CERTCACHE_LINENUMB, 25 };
	const struct CConfig::Param_Num CConfig::
		EIDMW_CONFIG_PARAM_CERTCACHE_VALIDITY =
		{ EIDMW_CNF_SECTION_CERTCACHE, EIDMW_CNF_CERTCACHE_VALIDITY, 15 * 60 };
	const struct CConfig::Param_Num CConfig::
		EIDMW_CONFIG_PARAM_CERTCACHE_WAITDELAY =
		{ EIDMW_CNF_SECTION_CERTCACHE, EIDMW_CNF_CERTCACHE_WAITDELAY, 2 * 60 };
...
EIDMW_CNF_GUITOOL_SHOWNOTIFICATION, 1 };
	...
	const struct CConfig::Param_Num CConfig::
		...
		{ EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_AUTOCARDREAD, 0 };
	const struct CConfig::Param_Num CConfig::
		EIDMW_CONFIG_PARAM_GUITOOL_CARDREADNUMB =
		{ EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_CARDREADNUMB, -1 };
	const struct CConfig::Param_Num CConfig::
	...
	const struct CConfig::Param_Num CConfig::
		...
		{ EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_REMOVECERTIF, 0 };
	const struct CConfig::Param_Str CConfig::
		EIDMW_CONFIG_PARAM_GUITOOL_FILESAVE =
		{ EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_FILESAVE, L"" };

//XSIGN
	const struct CConfig::Param_Str CConfig::
		EIDMW_CONFIG_PARAM_XSIGN_TSAURL =
		{ EIDMW_CNF_SECTION_XSIGN, EIDMW_CNF_XSIGN_TSAURL, L"http://tsa.belgium.be/connect" };
	const struct CConfig::Param_Num CConfig::
...
//MESSAGES
	const struct CConfig::Param_Num CConfig::
		...
		{ EIDMW_CNF_SECTION_MESSAGES, EIDMW_CNF_MESSAGES_SHOWSDK35WARN, 1 };
