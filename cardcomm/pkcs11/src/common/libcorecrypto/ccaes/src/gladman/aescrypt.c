...
void ccaes_gladman_encrypt(const cccbc_ctx *key, cccbc_iv *iv, unsigned long num_blk,
...
void ccaes_gladman_decrypt(const cccbc_ctx *key, cccbc_iv *iv, unsigned long num_blk,
                            const void *in, void *out)
{
    aes_32t        locals(b0, b1);
