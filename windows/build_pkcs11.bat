...
@"%BEID_DIR_VS_2010%\Common7\IDE\VCExpress.exe" "%~dp0..\pkcs11\VS_2010\beidpkcs11.sln" /clean "Release|Win32"
::@"%BEID_DIR_VS_2010%\Common7\IDE\VCExpress.exe" "%~dp0..\_src\eidmw\_Builds\BeidEasyBuild.sln" /clean "Release|x64"
@"%BEID_DIR_VS_2010%\Common7\IDE\VCExpress.exe" "%~dp0..\pkcs11\VS_2010\beidpkcs11.sln" /build "Release|Win32"
::@"%BEID_DIR_VS_2010%\Common7\IDE\VCExpress.exe" "%~dp0..\_src\eidmw\_Builds\BeidEasyBuild.sln" /build "Release|x64"
@"%BEID_DIR_VS_2010%\Common7\IDE\VCExpress.exe" "%~dp0..\_src\eID-QuickInstaller\eID-EZinstaller\eID-EZinstaller.sln" /build "Release|Win32"
