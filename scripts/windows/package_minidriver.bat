...
robocopy %~dp0..\..\installers\quickinstaller\Drivers\WIN7_WIN81\beidmdrv %~dp0\beidmdr_all\WIN7_WIN81 beidmdrv32.dll beidmdrv64.dll beidmdrv_arm64.dll beidmdrv.inf
