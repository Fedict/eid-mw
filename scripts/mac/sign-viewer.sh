...
codesign -s "Developer ID Application" "/Volumes/eID Viewer.app/Contents/Frameworks/BeidView.framework"
codesign -s "Developer ID Application" "/Volumes/eID Viewer.app"
