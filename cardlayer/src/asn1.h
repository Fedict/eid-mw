...
EIDMW_CAL_API int asn1_get_item(const unsigned char *content, unsigned int len, const char *path, ASN1_ITEM *item);
EIDMW_CAL_API int asn1_find_item(const unsigned char *content, unsigned int len, unsigned int findtag, ASN1_ITEM *item);
EIDMW_CAL_API int dec_oid( unsigned char *p_data, int l_data, unsigned int *oid, int l_oid);
EIDMW_CAL_API int asn1_next_item(ASN1_ITEM          *p_xLev0,       /**< In/out: object   */
