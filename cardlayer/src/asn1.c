...
EIDMW_CAL_API int asn1_get_item(const unsigned char *p_cInDat,     /**< In: ASN-1 data */
                  unsigned int        iInLen,        /**< In: ASN-1 len   */
...
EIDMW_CAL_API int asn1_next_item(ASN1_ITEM          *p_xLev0Item,      /**< In/out: object   */
...
EIDMW_CAL_API int asn1_find_item(const unsigned char *p_cInDat, /**< In: ASN-1 data */
                   unsigned int iInLen,           /**< In: ASN-1 len   */
...
EIDMW_CAL_API int dec_oid( unsigned char *p_data, 
             int           l_data, 
             unsigned int  *oid, 
             int           l_oid)
{
