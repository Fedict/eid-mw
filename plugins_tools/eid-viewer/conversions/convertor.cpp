...
void* Convertor::convert_from_xml(const EID_CHAR* name, const EID_CHAR* value, int* len_return) {
	if(!value) {
		*len_return = 0;
...
EID_CHAR* Convertor::convert_to_xml(const EID_CHAR* label, const EID_CHAR* normal) {
