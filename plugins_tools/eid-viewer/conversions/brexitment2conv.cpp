...
BrexitMention2Convertor::BrexitMention2Convertor() {
	if(conversions.size() == 0)
	{
		...
		conversions[EID_VWR_GRAPH_VERSION_EIGHT][EID_VWR_LANG_DE]['C'] = TEXT("DAUERAUFENTHALT");
		conversions[EID_VWR_GRAPH_VERSION_EIGHT][EID_VWR_LANG_EN]['C'] = TEXT("PERMANENT STAY");
		conversions[EID_VWR_GRAPH_VERSION_EIGHT][EID_VWR_LANG_FR]['C'] = TEXT("SEJOUR PERMANENT");
		conversions[EID_VWR_GRAPH_VERSION_EIGHT][EID_VWR_LANG_NL]['C'] = TEXT("DUURZAAM VERBLIJF");
	}
}
