...
BrexitMention1Convertor::BrexitMention1Convertor() {
	if(conversions.size() == 0)
	{
		...
		conversions[EID_VWR_GRAPH_VERSION_EIGHT][EID_VWR_LANG_DE]['B'] = TEXT("ARTIKEL 18(1) VEREINBARUNG");
		conversions[EID_VWR_GRAPH_VERSION_EIGHT][EID_VWR_LANG_EN]['B'] = TEXT("ARTICLE 18(1) AGREEMENT");
		conversions[EID_VWR_GRAPH_VERSION_EIGHT][EID_VWR_LANG_FR]['B'] = TEXT("ARTICLE 18(1) ACCORD");
		conversions[EID_VWR_GRAPH_VERSION_EIGHT][EID_VWR_LANG_NL]['B'] = TEXT("ARTIKEL 18(1) AKKOORD");
	}
}
