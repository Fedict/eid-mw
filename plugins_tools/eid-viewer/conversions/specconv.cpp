...
SpecConvertor::SpecConvertor()
{
	...
	conversions[EID_VWR_LANG_DE]['2'] =
		TEXT("Verlängerte Minderjährigkeit");
	conversions[EID_VWR_LANG_DE]['3'] =
		TEXT("Weißer Stock\nVerlängerte Minderjährigkeit");
	conversions[EID_VWR_LANG_DE]['4'] = TEXT("Gelber Stock");
	conversions[EID_VWR_LANG_DE]['5'] =
		TEXT("Gelber Stock\nVerlängerte Minderjährigkeit");
	...
	conversions[EID_VWR_LANG_EN]['3'] =
		TEXT("White Cane\nExtended Nonage");
	conversions[EID_VWR_LANG_EN]['4'] = TEXT("Yellow Cane");
	conversions[EID_VWR_LANG_EN]['5'] =
		TEXT("Yellow Cane\nExtended Nonage");
	...
	conversions[EID_VWR_LANG_FR]['3'] =
		TEXT("Canne blanche\nMinorité étendue");
	conversions[EID_VWR_LANG_FR]['4'] = TEXT("Canne jaune");
	conversions[EID_VWR_LANG_FR]['5'] =
		TEXT("Canne jaune\nMinorité étendue");
	...
	conversions[EID_VWR_LANG_NL]['3'] =
		TEXT("Witte stok\nVerlengde minderjarigheid");
	conversions[EID_VWR_LANG_NL]['4'] = TEXT("Gele stok");
	conversions[EID_VWR_LANG_NL]['5'] =
		TEXT("Gele stok\nVerlengde minderjarigheid");
}
