...
DocTypeConvertor::DocTypeConvertor() {
	conversions[EID_VWR_LANG_DE]["01"] = "PERSONALAUSWEIS";
	conversions[EID_VWR_LANG_DE]["06"] = "KIDS-KARTE";
	conversions[EID_VWR_LANG_DE]["07"] = "STARTKARTE";
	conversions[EID_VWR_LANG_DE]["08"] = "Berechtigungskarte";
	// Foreigner A
	...
	conversions[EID_VWR_LANG_EN]["01"] = "IDENTITY CARD";
	conversions[EID_VWR_LANG_EN]["06"] = "KIDS CARD";
	conversions[EID_VWR_LANG_EN]["07"] = "BOOTSTRAP CARD";
	conversions[EID_VWR_LANG_EN]["08"] = "Habilitation Card";
	// Foreigner A
	...
	conversions[EID_VWR_LANG_FR]["01"] = "CARTE D'IDENTITE";
	conversions[EID_VWR_LANG_FR]["06"] = "CARTE POUR ENFANTS";
	conversions[EID_VWR_LANG_FR]["07"] = "CARTE DE DEMARRAGE";
	conversions[EID_VWR_LANG_FR]["08"] = "CARTE D'HABILITATION";
	// Foreigner A
	...
	conversions[EID_VWR_LANG_NL]["01"] = "IDENTITEITSKAART";
	conversions[EID_VWR_LANG_NL]["06"] = "KIDS KAART";
	conversions[EID_VWR_LANG_NL]["07"] = "OPSTARTKAART";
	conversions[EID_VWR_LANG_NL]["08"] = "HABILITATIEKAART";
	// Foreigner A";
...
std::string DocTypeConvertor::convert(const char* normal) {
	if(conversions.count(target_) > 0) {
		if(conversions[target_].count(normal) > 0) {
			return conversions[target_][normal];
		}
	}
	return normal;
}
