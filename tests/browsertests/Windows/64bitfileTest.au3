...
Func checkdetails($file)
	...
	If $version == FileGetVersion($CmdLine[1])Then
		$ok = 1
	Else
...
EndIf
If $procede Then
	$procede = checkdetails("C:\Windows\System32\DriverStore\FileRepository\beidmdrv.inf_amd64_47cca707f6231b81\beidmdrv64.dll")
EndIf
If $procede Then
	$procede = checkdetails("C:\Windows\SysWOW64\beid_ff_pkcs11.dll")
EndIf
If $procede Then
	$procede = checkdetails("C:\Windows\SysWOW64\beidpkcs11.dll")
EndIf
If $procede Then
	$procede = checkdetails("C:\Windows\SysWOW64\beidmdrv32.dll")
EndIf
If $procede Then
EndIf
If $procede Then
