...
"%BEID_DIR_WIX%\candle.exe" -v -dLang=nl -out obj\Product64.wixobj -arch x64 -ext "%BEID_DIR_WIX%\WixDifxAppExtension.dll" -ext "%BEID_DIR_WIX%\WixUtilExtension.dll" -ext "%BEID_DIR_WIX%\WixUIExtension.dll" %~dp0\Product64.wxs
@if NOT "%ERRORLEVEL%" == "0" goto msi_failed
"%BEID_DIR_WIX%\Light.exe" -v -cultures:nl-nl -ext "%BEID_DIR_WIX%\WixDifxAppExtension.dll" -ext "%BEID_DIR_WIX%\WixUtilExtension.dll" -ext "%BEID_DIR_WIX%\WixUIExtension.dll" -loc %~dp0\Strings-nl.wxl -loc WixUI_nl-nl.wxl -out bin\nl-nl\BeidMW64-Basic-nl.msi -pdbout bin\nl-nl\BeidMW64-Basic-nl.wixpdb -sice:ICE09 obj\Product64.wixobj "%BEID_DIR_WIX%\difxapp_x64.wixlib"
@if NOT "%ERRORLEVEL%" == "0" goto msi_failed
