...
#####################################################################
Echo "********** building and signing the QI **********"

  Echo "********** building $PKG_NAME **********"
  productbuild --distribution "$RELEASE_BEIDCLEANCERTS_DIR/Distribution_export.txt" --resources "$BEIDCLEANCERTS_RESOURCES_DIR" $PKG_NAME
