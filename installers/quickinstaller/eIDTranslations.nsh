...
LangString ls_complete ${LANG_FRENCH} "eID software geïnstalleerd!"
...
LangString ls_complete_info ${LANG_FRENCH} "U kan de eID software testen met behulp van een geschikte eID kaartlezer.$\nKlik op 'Testen' en volg de instructies stap voor stap"
LangString ls_complete_info ${LANG_DUTCH} "U kan de eID software testen met behulp van een geschikte eID kaartlezer.$\nKlik op 'Testen' en volg de instructies stap voor stap"
LangString ls_complete_info ${LANG_GERMAN} "U kan de eID software testen met behulp van een geschikte eID kaartlezer.$\nKlik op 'Testen' en volg de instructies stap voor stap"

LangString ls_testcomplete_pre ${LANG_ENGLISH} "Beste "
LangString ls_testcomplete_pre ${LANG_FRENCH} "Beste"
LangString ls_testcomplete_pre ${LANG_DUTCH} "Beste"
LangString ls_testcomplete_pre ${LANG_GERMAN} "Beste"
...
LangString ls_testcomplete_info ${LANG_ENGLISH} "Herstarten van uw computer is aanbevolen"
LangString ls_testcomplete_info ${LANG_FRENCH} "Herstarten van uw computer is aanbevolen"
LangString ls_testcomplete_info ${LANG_DUTCH} "Herstarten van uw computer is aanbevolen"
LangString ls_testcomplete_info ${LANG_GERMAN} "Herstarten van uw computer is aanbevolen"

LangString ls_install_failed ${LANG_ENGLISH} "eID software niet geïnstalleerd"
LangString ls_install_failed ${LANG_FRENCH} "eID software niet geïnstalleerd"
...
LangString ls_install_failed_info ${LANG_FRENCH} "We hebben de eID software niet kunnen installeren.$\nKlik op 'Helpwebsite' voor meer informatie"
...
LangString ls_cardreader_failed ${LANG_FRENCH} "Kaartlezer niet gevonden"
LangString ls_cardreader_failed ${LANG_DUTCH} "Kaartlezer niet gevonden"
LangString ls_cardreader_failed ${LANG_GERMAN} "Kaartlezer niet gevonden"

LangString ls_cardreader_failed_info ${LANG_ENGLISH} "Controleer of deze correct is aangesloten en klik op 'Opnieuw'.$\nAls dit probleem aanhoudt, klik op 'Ga naar helpwebsite' voor meer informatie"
LangString ls_cardreader_failed_info ${LANG_FRENCH} "Controleer of deze correct is aangesloten en klik op 'Opnieuw'.$\nAls dit probleem aanhoudt, klik op 'Ga naar helpwebsite' voor meer informatie"
LangString ls_cardreader_failed_info ${LANG_DUTCH} "Controleer of deze correct is aangesloten en klik op 'Opnieuw'.$\nAls dit probleem aanhoudt, klik op 'Ga naar helpwebsite' voor meer informatie"
LangString ls_cardreader_failed_info ${LANG_GERMAN} "Controleer of deze correct is aangesloten en klik op 'Opnieuw'.$\nAls dit probleem aanhoudt, klik op 'Ga naar helpwebsite' voor meer informatie"

LangString ls_test_failed ${LANG_ENGLISH} "De test is niet geslaagd"
LangString ls_test_failed ${LANG_FRENCH} "De test is niet geslaagd"
...
LangString ls_pleaseinsertcard ${LANG_ENGLISH} "Steek uw eID in de kaartlezer"
LangString ls_pleaseinsertcard ${LANG_FRENCH} "Steek uw eID in de kaartlezer"
LangString ls_pleaseinsertcard ${LANG_DUTCH} "Steek uw eID in de kaartlezer"
LangString ls_pleaseinsertcard ${LANG_GERMAN} "Steek uw eID in de kaartlezer"
...
LangString ls_helpsite ${LANG_FRENCH} "Helpwebsite"
LangString ls_helpsite ${LANG_DUTCH} "Helpwebsite"
LangString ls_helpsite ${LANG_GERMAN} "Helpwebsite"

LangString ls_caption ${LANG_ENGLISH} "eID software installatie"
LangString ls_caption ${LANG_FRENCH} "eID software installatie"
...
LangString ls_completedtext ${LANG_FRENCH} "klaar"
LangString ls_completedtext ${LANG_DUTCH} "klaar"
LangString ls_completedtext ${LANG_GERMAN} "klaar"
