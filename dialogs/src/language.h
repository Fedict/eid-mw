...
DEFINE_LANG_STR(Retry) = {L"&Retry", L"O&pnieuw", L"&RÈessayer", L"&Erneut versuchen"};
...
DEFINE_LANG_STR(AnApplicationWantsToAccessTheCard) = {L"An Application wants to access the card !", L"Een Programma wil toegang tot de kaart !", L"Une application essaye d'accÈder ‡ la carte !", L"Eine Anwendung will auf die Karte zugreifen!"};
DEFINE_LANG_STR(ReadIdentityData) = {L"Read Identity data", L"Identiteitsgegevens lezen", L"Lire les informations d'identitÈe", L"Identit‰tsdaten lesen"};
...
DEFINE_LANG_STR(ReadUnknownData) = {L"Read Unknown data", L"Onbekende data lezen", L"Lire des donnÈes", L"Unbekannte Daten lesen"};
DEFINE_LANG_STR(DoYouWantToAcceptIt) = {L"Do you want to accept it ?", L"Wil U dit toelaten ?", L"Acceptez-vous ?", L"Mˆchten Sie akzeptieren?"};
DEFINE_LANG_STR(ForAllOperations) = {L"For all operations", L"Voor alle gegevens", L"Pour toutes les opÈrations", L"F¸r alle Funktionen"};
...
DEFINE_LANG_STR(ForVerification) = {L"for verification", L"voor verificatie", L"pour vÈrification", L"zwecks Best‰tigung"};
DEFINE_LANG_STR(ToUnblock) = {L"to unblock", L"om vrij te geven", L"pour dÈbloquer", L"um freizugeben"};
...
DEFINE_LANG_STR(ConfirmNewPin) = {L"Confirm new PIN", L"Bevestig nieuwe PIN", L"Confimez", L"Neue PIN best‰tigen"};
...
DEFINE_LANG_STR(EnterYourNewPinCodeAgainToConfirm) = {L"Enter your New PIN code again to confirm", L"Bevestig Uw nieuwe PIN", L"Confimez votre nouveau code PIN", L"Neue PIN-Kennzahl erneut best‰tigen"};
...
DEFINE_LANG_STR(RetryEnterYourNewPinCode) = {L"Retry: Enter your New PIN code", L"Geef nogmaals uw nieuwe PIN code", L"RÈessayez: Entrez votre nouveau code PIN", L"Erneut versuchen: Neue PIN-Kennzahl eingeben"};
...
DEFINE_LANG_STR(RemainingAttempts) = {L"remaining attempts", L"overblijvende pogingen", L"essais restants", L"¸brige Versuche"};
...
DEFINE_LANG_STR(PinBlocked) = {L"PIN blocked", L"PIN geblokkeerd", L"Code PIN bloquÈ", L"PIN gesperrt"};
...
DEFINE_LANG_STR(ThisMayBeATestCard) = {L"This may be a test card.", L"Dit kan een testkaart zijn.", L"Il s'agit peut-Ítre d'une carte de test.", L"Dies kann eine Testkarte sein."};
DEFINE_LANG_STR(PleaseEnterTheCorrectEidCard) = {L"Please enter the correct eID card.", L"Gelieve de geldige eID kaart in te steken.", L"InsÈrez une carte valide.", L"Bitte geben Sie die richtige eID-Karte ein."};
DEFINE_LANG_STR(Caution) = {L"Caution:", L"Let op:", L"Attention:", L"Achtung:"};
DEFINE_LANG_STR(YouAreAboutToMakeALegallyBindingElectronic) = {L"You are about to make a legally binding electronic signature with your identity card.", L"U gaat een wettelijk bindende electronische handtekening plaatsen met uw identiteitskaart.", L"Vous allez apposer une signature Èlectronique juridiquement valide avec votre carte d'identitÈ", L"Mit Ihrem Personalausweis werden Sie eine rechtsg¸ltige elektronische Unterschrift eingeben."};
...
DEFINE_LANG_STR(PleaseEnterYourPinOnThePinpadReader) = {L"Please enter your PIN on the pinpad reader", L"Geef uw PIN in op de kaartlezer", L"Entrez votre code PIN sur le clavier du lecteur de carte", L"Bitte geben Sie Ihre PIN am Kartenleseger‰t ein"};
DEFINE_LANG_STR(ToContinueOrClickTheCancelButton) = {L"to continue or click the Cancel button.", L"om verder te gaan", L"ou cliquez sur le bouton Annuler.", L"um fortzufahren, oder klicken Sie auf die Schaltfl‰che \"Abbrechen\"."};
DEFINE_LANG_STR(Warning) = {L"Warning:", L"Waarschuwing:", L"Avertissement:", L"Warnung:"};
DEFINE_LANG_STR(IfYouOnlyWantToLogOnToA) = {L"If you only want to log on to a web site or server, do NOT enter your PIN and click the Cancel button.", L"Als u enkel wil aanloggen op een web site of een server, geef uw PIN NIET in.", L"Si vous dÈsirez seulement vous connecter ‡ un site ou un serveur, n'entrez PAS votre code PIN.", L"Wenn Sie nur auf das Internet oder einen Server gehen mˆchten, geben Sie bitte Ihre PIN NICHT ein."};
...
DEFINE_LANG_STR(ChangeYourPinOnTheReader) = {L"Change your PIN on the reader", L"Verander uw PIN op de lezer", L"Modifiez votre code PIN sur le lecteur de carte", L"Bitte ‰ndern Sie Ihren PIN am Kartenleseger‰t"};
...
DEFINE_LANG_STR(PleaseEnterYourPukOnThePinpadReader) = {L"Please enter your PUK on the pinpad reader", L"Geef uw PUK in op de kaartlezer", L"Entrez votre code PUK sur le clavier du lecteur de carte", L"Bitte geben Sie Ihren PUK am Kartenleseger‰t ein"};
DEFINE_LANG_STR(Your) = {L"your", L"uw", L"votre", L"Ihre"};
DEFINE_LANG_STR(ChangeYourPin) = {L"Change your PIN", L"Wijzig uw PIN", L"Modifiez votre code PIN", L"Bitte ‰ndern Sie Ihren PIN"};
DEFINE_LANG_STR(ChangeYourPuk) = {L"Change your PUK", L"Wijzig uw PUK", L"Modifiez votre code PUK", L"Bitte ‰ndern Sie Ihren PUK"};
DEFINE_LANG_STR(OnTheReader) = {L"on the reader", L"op de lezer", L"sur le lecteur de carte", L"am Kartenleseger‰t"};
DEFINE_LANG_STR(TheFollowingApplication1IsTrying) = {L"The following application '%1' is trying to read data on the eID card.\n\nDo you allow that?", L"Het volgende programma '%1' tracht gegevens te lezen van de eID kaart.\n\nStaat U dit toe?", L"Cette application '%1' essaye de lire vos donnÈes sur la carte eID.\n\nAcceptez-vous?", L"Das folgende Programm '%1' versucht, Daten auf der eID-Karte zu lesen.\n\nErlauben Sie das?"};
...
DEFINE_LANG_STR(EnterOldNewVerify) = {L"1) Enter your old PIN and press 'OK'. \n2) Enter your new PIN and press 'OK'.\n3) Enter your new PIN again and press 'OK'.",
																			...
																			L"1) InsÈrez votre ancien code PIN et appuyez sur ´†OK†ª.\n2) InsÈrez votre nouveau code PIN et appuyez sur ´†OK†ª.\n3) InsÈrez une nouvelle fois votre nouveau code PIN et appuyez sur ´†OK†ª.",
...
DEFINE_LANG_STR(OldSDK35Notification) = {L"This application was built against the Belgium Identity Card SDK, version 3.5.\nThis version is considered deprecated and will not be supported by future versions of the eID middleware.\n\n\nPlease contact the application vendor.",																		
																			...
																			L"Cette application a ÈtÈ dÈveloppÈe pour le SDK (kit de dÈveloppement logiciel) de la carte díidentitÈ belge, version 3.5.\nCette version est considÈrÈe comme obsolËte et ne sera pas compatible avec les futures versions du middleware eID.\n\n\nVeuillez prendre contact avec le fournisseur de líapplication.",
																			L"Diese Anwendung wurde mit dem SDK Belgischer Personalausweis, Version 3.5, entwickelt. \nDiese Version gilt nun als veraltet und wird von zuk¸nftigen Versionen der eID-Middleware nicht unterst¸tzt.\n\n\nBitte wenden Sie sich an den Verk‰ufer der Anwendung."};
